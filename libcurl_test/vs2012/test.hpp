...
static const char *payload_text[] = {
  ...
  "From: " FROM "\r\n",
  "Cc: " CC "\r\n",
  "Message-ID: <dcd7cb36-11db-487a-9f3a-e652a9458efd@192.168.0.6>\r\n",
  "Subject: ttray again!! confirm your email.\r\n",
...
int mail_test(void)
{
  ...
  if(curl) {
    ...
    curl_easy_setopt(curl, CURLOPT_USERNAME, "Andrea@192.168.0.6");
    curl_easy_setopt(curl, CURLOPT_PASSWORD, "stonestone");
 
    /* This is the URL for your mailserver. Note the use of port 587 here,
     * instead of the normal SMTP port (25). Port 587 is commonly used for
     * secure mail submission (see RFC4403), but you should use whatever
     * matches your server configuration. */ 
    curl_easy_setopt(curl, CURLOPT_URL, "smtp://192.168.0.6");
